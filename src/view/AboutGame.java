...
public class AboutGame extends javax.swing.JFrame {
    ...
    public AboutGame() throws LineUnavailableException, UnsupportedAudioFileException, IOException {
        initComponents();
        loadResources();
    ...
    private void initComponents() {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addComponent(jLabel1, javax.swing.GroupLayout.DEFAULT_SIZE, 1281, Short.MAX_VALUE)
        );
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(AboutGame.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public javax.swing.JButton btnReturn1;
